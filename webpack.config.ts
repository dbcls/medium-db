...
export default makeConfig({
      ...
      middleware: [
        historyApiFallback({
          rewrites: [
            ...
            {
              from: /^\/compare_by_organisms\//,
              to: "/compare_by_organisms/index.html",
            },
  ...
  pug: {
    ...
    files: {
      ...
      "compare_by_organisms/index.html": "compare_by_organisms.pug",
  ...
  ts: {
    ...
    files: {
      ...
      "compare_by_organisms.js": "compare_by_organisms.ts",
