Stanza(function(stanza, params){
  ...
  let q = Promise.all([
    fetch(newick_url, options_text).then(res => res.text()), fetch(code_tid_api, options_json).then(res => res.json())
  ]);
...
//	console.log(json);
    ...
    let tree = d3.tree()
      .size([360, r - 80])
      .separation(function(a, b){ return (a.parent == b.parent ? 1 : 2) / a.depth; });   // tree type
    cluster(draw_data);
